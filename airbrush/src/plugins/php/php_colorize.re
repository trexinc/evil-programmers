...
/*!re2c
  ...
  { if(lColorize) Info.pAddColor(lno,yytok-line,yycur-yytok,colors[HC_VAR],colors[HC_VAR+1]); goto colorize_clear; }
  ...
  [ \t\v\f]+
  {
    if(lColorize) Info.pAddColor(lno,yytok-line,yycur-yytok,colors[HC_COMMON],colors[HC_COMMON+1]);
    goto colorize_clear;
  }
  L+
  {
