...
const TCHAR* colornames[]={_T("Comment"),_T("Keyword"),_T("Label"),_T("String"),_T("Number"),_T("Hex Number"),_T("--FIXME"),_T("Pair"),_T("Wrong Pair")};
...
{
  (void)index;
  static const ABName name={LuaGUID,_T("lua")};
  switch(command)
  {
    case PAR_GET_NAME:
