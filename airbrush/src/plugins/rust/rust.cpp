...
const wchar_t* colornames[]={L"Comment",L"Keyword",L"String",L"Number",L"Attribute",L"//FIXME",L"Pair",L"Wrong Pair"};
...
{
  (void)index;
  static const ABName name={RustGUID,L"rust"};
  switch(command)
  {
    case PAR_GET_NAME:
