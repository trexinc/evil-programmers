...
substr, возвращает -1.
 ...
 string #sprintf# ( string format, ...)
   ...
   Пишет форматированый текст в строку. sprintf получает набор параметров,
   ...
   формата к первому параметру, втотрой второму и т.д.. Количество
   определителей формата должно соответсвовать количеству параметров.
   Строка формата определена так же как и в C/C++.
