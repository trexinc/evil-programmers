...
extern void FilterUndoInit(HANDLE aDlg,intptr_t aMsg,intptr_t aParam1,void* aParam2);
extern void FilterUndoEnd(HANDLE aDlg,intptr_t aMsg,intptr_t aParam1,void* aParam2,intptr_t Result);
