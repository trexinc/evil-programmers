...
extern int GetLevelFromUserData(void* UserData);
extern int GetSortOrderFromUserData(void* UserData);
extern int GetItemTypeFromUserData(void* UserData);
extern PSID GetSidFromUserData(void* UserData);
extern wchar_t *GetWideNameFromUserData(void* UserData);
