@echo off
set macrokey=CtrlShiftA
set macrodesceng=BCopy: Background attributes setting
set macrodescrus=BCopy: Фоновая установка атрибутов
...
echo "Sequence"="F11 b 4 CtrlA"                       >>%MacroTmp%
