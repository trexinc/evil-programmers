@echo off
set macrokey=CtrlShiftF4
set macrodesceng=BCopy: Edit file
set macrodescrus=BCopy: Редактирование файла
...
echo "Sequence"="F11 b ] CtrlShiftF4"                 >>%MacroTmp%
echo "Description"="%macrodesc%"                      >>%MacroTmp%
echo "DisableOutput"=dword:00000001                   >>%MacroTmp%
echo "NoPluginPanels"=dword:00000000                  >>%MacroTmp%
echo "NoFolders"=dword:00000001                       >>%MacroTmp%
