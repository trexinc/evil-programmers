@echo off
set macrokey=ShiftEnter
set macrodesceng=BCopy: Shell execute
set macrodescrus=BCopy: Запуск файла
...
echo "Sequence"="F11 b 0"                             >>%MacroTmp%
echo "Description"="%macrodesc%"                      >>%MacroTmp%
echo "DisableOutput"=dword:00000001                   >>%MacroTmp%
echo "EmptyCommandLine"=dword:00000001                >>%MacroTmp%
echo "NoPluginPanels"=dword:00000001                  >>%MacroTmp%
