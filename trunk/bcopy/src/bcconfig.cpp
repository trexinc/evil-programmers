...
static int Config()
{
  ...
  while(TRUE)
  {
    ...
    else if(MenuCode==1)
    {
      ...
      07   ÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Info menu ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶   07
      08   º [ ] &Display message when job list is empty                        º   08
      09   º [ ] Autoselect &only job                                           º   09
      10   ÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶   10
      11   º [ ] Auto&show information dialog                                   º   11
      12   º [ ] E&xpand variables in copy dialog                               º   12
      13   º [ ] Don't &check passive panel type                                º   13
      14   º [ ] &Format size                                                   º   14
      15   º [ ] Show current time                                              º   15
      16   º [ ] Co&nfirm abort                                                 º   16
      17   º [ ] Auto&refresh                                                   º   17
      18   ÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶   18
      19   º                 [ Save ]              [ Cancel ]                   º   19
      20   ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼   20
      21                                                                            21
        0000000000111111111122222222223333333333444444444455555555556666666666777777
        0123456789012345678901234567890123456789012345678901234567890123456789012345
      */
