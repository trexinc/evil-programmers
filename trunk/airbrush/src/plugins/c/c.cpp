...
ColorizeInfo Info;
int colors[]={0x03,-1,0x0F,-1,0x0D,-1,0x0E,-1,0x0A,-1,0x0A,-1,0x02,-1,0x00,0x0A,0x0C,-1,0x01,0x0C};
const char *colornames[]={"Comment","Keyword","\";\" Symbol","String","Number","Hex Number","Preprocessor","//FIXME","Pair","Wrong Pair"};
